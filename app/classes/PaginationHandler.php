...
class PaginationHandler extends Model
{
	...
	public function create_pagination()
	{
		...
		$pagination .=
			...
			<a class="page-link" href="' . buildURL($this->pattern, [$this->variable => $this->page - 1], false, false) . '" title="Previous">&laquo;</a>
		</li>';
		...
		$pagination .=
			...
			<a class="page-link" href="' . buildURL($this->pattern, [$this->variable => $this->page + 1], false, false) . '" title="Next">&raquo;</a>
		</li>';
		$pagination .= '</ul>';

		// Dynamic pagination links
		$this->pagination = $pagination;
		$this->pagination .= sprintf('<small class="text-muted">Page %s of %s, showing %s-%s of %s results.</small>', $this->page, $this->pages, $this->start, $this->end, $this->total);
