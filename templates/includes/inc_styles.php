...
<!-- All plugins should be included here. -->
<!-- Toastr css -->
...
<!-- Header styles should be included here. -->
<style>
  .btn {
    border-radius: 5px;
  }
...
<!-- Manually registered styles -->
<?php echo load_styles(); ?>

<!-- Custom styles should be included in main.css or here. -->
