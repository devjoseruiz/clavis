<h4 class="d-flex justify-content-between align-items-center mb-3">
  <span class="text-muted">Movements</span>
...
<ul class="list-group mb-3">
  ...
  bee_movement" data-id="<?php echo $mov->id; ?>">
        <div class="<?php echo $mov->type === 'income' ? 'text-success' : 'text-danger'; ?>">
          <h6 class="my-0"><?php echo $mov->type === 'income' ? 'Income' : 'Expense'; ?></h6>
          <small class="text-muted"><?php echo $mov->description; ?></small>
        </div>
        <button class="btn btn-sm btn-danger float-end bee_delete_movement" data-id="<?php echo $mov->id; ?>"><i
